    ...
    def get_context_data(self, **kwargs):
        ...
        for dispositivo in dispositivos:
            ...
            data = {
                ...
                'caracteristics_url': f"/{self.request.resolver_match.namespace}/cliente/dispositivos/{dispositivo.id}/caracteristics/",
            }
...
class ClienteCaracteristicsView(UserPassesTestMixin, TemplateView):
    template_name = 'inventario/cliente_caracteristics.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        caracteristics = DispositivoCaracteristica.objects.filter(dispositivo_id_dispositivo=dispositivo)
        return {
