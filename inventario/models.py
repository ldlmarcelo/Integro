...
# Modelo de Gerencia (tabla separada)
...
class CustomUser(AbstractUser):
    gerencia = models.ForeignKey(Gerencia, models.DO_NOTHING, blank=True, null=True, verbose_name="Gerencia") # ForeignKey a Gerencia, blank=True, null=True revisado
...
# Modelo para el Tipo de Dispositivo (tabla de catálogo)
...
# Modelo para la Cantidad de Memoria (tabla de catálogo)
...
# Modelo para la Marca (tabla de catálogo)
...
# Modelo para el Tipo de Memoria (tabla de catálogo)
...
# Modelo para el Modelo de Dispositivo (tabla de catálogo, relacionada con Marca)
...
# Modelo para el Estado del Dispositivo (tabla de catálogo)
...
# Modelo para la Ubicación del Dispositivo
...
# Modelo para la Característica (tabla de catálogo general)
...
# Modelo para Características Específicas Unificado
...
# Modelo principal para Dispositivos
...
# Modelo para el Historial de Estados del Dispositivo
class DispositivoEstado(models.Model):
    ...
    dispositivo_id_dispositivo = models.ForeignKey(Dispositivo, models.DO_NOTHING, db_column='dispositivo_id_dispositivo', verbose_name="Dispositivo") # Requerido
    estado_id_estado = models.ForeignKey('Estado', models.DO_NOTHING, db_column='estado_id_estado', verbose_name="Estado") # Requerido
...
# Modelo para el Historial de Ubicación del Dispositivo
...
# Modelo para el Historial de Propietarios del Dispositivo
class DispositivoPropietarioHistorico(models.Model):
    id_dispositivo_propietario_historico = models.AutoField(primary_key=True)
    dispositivo = models.ForeignKey(Dispositivo, models.DO_NOTHING, verbose_name="Dispositivo") # Requerido
    propietario_id_anterior = models.ForeignKey(CustomUser, models.DO_NOTHING, db_column='propietario_id_anterior', blank=True, null=True, related_name='%(class)s_anterior', verbose_name="Propietario Anterior") # Opcional
    propietario_id_nuevo = models.ForeignKey(CustomUser, models.DO_NOTHING, db_column='propietario_id_nuevo', related_name='%(class)s_nuevo', verbose_name="Propietario Nuevo") # Requerido
